...
<template>
  <div index-page>
    <header>
      ...
      <a href="https://github.com/logotip4ik" target="_blank" rel="noopener noreferrer">gh</a>
    </header>

    <p>This is a place to put some of my thoughts, share code snippets and improve my skills as developer. Enjoy 😁</p>
